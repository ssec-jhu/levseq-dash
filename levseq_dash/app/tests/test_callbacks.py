...
def test_callback_update_explore_page_buttons(mock_load_config_from_test_data_path):
...
def test_callback_update_explore_page_buttons_multiple_selection(mock_load_config_from_test_data_path):
